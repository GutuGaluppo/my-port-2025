...
import { Container, Typography, Grid, Card, CardContent, CardMedia, Chip, Button, Box, Tabs, Tab } from '@mui/material';
import { Launch, GitHub, Code } from '@mui/icons-material';
  ...
  const projects = [
    {
      ...
      description: 'A responsive multi-step form built with React and Material UI, featuring form validation and smooth transitions.',
    ...
    },
    {
      ...
      description: 'Mobile-first calendar component with touch gestures and responsive design.',
      image: '/api/placeholder/400/250',
    ...
    },
    {
      ...
      description: 'Modern glassmorphism UI components with backdrop blur effects and elegant animations.',
      image: '/api/placeholder/400/250',
    ...
    },
    {
      ...
      description: 'Beautiful music player interface with light mode design and smooth animations.',
      image: '/api/placeholder/400/250',
      technologies: ['CSS3', 'HTML5', 'JavaScript'],
      category: 'css',
    ...
    },
    {
      ...
      description: 'Interactive tool for testing REST APIs with request/response visualization.',
      image: '/api/placeholder/400/250',
    ...
    },
    {
      ...
      description: 'Drag and drop file upload component with progress tracking and preview.',
      image: '/api/placeholder/400/250',
